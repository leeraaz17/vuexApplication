...
const routes = [{ path: '', component: __WEBPACK_IMPORTED_MODULE_0__ProductList_vue___default.a }, {
    path: '/products/:productId',
    name: 'viewProduct',
    props: true,
    component: __WEBPACK_IMPORTED_MODULE_1__ViewProduct_vue___default.a
}, { path: '/cart', component: __WEBPACK_IMPORTED_MODULE_2__Cart_vue___default.a }, { path: '*', component: { template: '<h1>Page Not Found!</h1>' } }];
...
// module
exports.push([module.i, "#products .item img{background-color:#000;cursor:pointer}#products .item p.lead{margin-bottom:0}#products .item .number-in-stock{margin-right:10px}#products .item .number-in-stock.few{color:#e0a14f}#products .item .number-in-stock.none{color:#c45e5e}", ""]);
...
// module
exports.push([module.i, ".flex{display:flex}.flex.flex-column{flex-direction:column}.flex.flex-row{flex-direction:row}.flex.justify-center{justify-content:center}.flex.justify-left{justify-content:flex-start}.flex.justify-right{justify-content:flex-end}.flex.align-center{align-items:center}.flex.align-left{align-items:flex-start}.flex.align-right{align-items:flex-end}.navbar .stats{margin:15px 0 0 10px}.navbar .navbar-right>*{float:right}", ""]);
    ...
    return _c('div', {
      ...
      on: {
        "click": function($event) {
          return _vm.addProductToCart(product, 1)
        }
      }
  ...
  return _c('div', [_c('button', {
    ...
    on: {
      "submit": function($event) {
        $event.preventDefault();
        return _vm.addNewReview(_vm.newReview)
      }
    }
  }, [_c('div', {
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    staticClass: "stats"
  }, [_vm._v(_vm._s(_vm.cart.items.length) + " "), (_vm.cart.items.length == 1) ? [_vm._v("item")] : [_vm._v("items")], _vm._v(" in cart, totalling " + _vm._s(_vm._f("currency")(_vm.cartTotal)))], 2)])])])]), _vm._v(" "), _c('transition', {
    attrs: {
...
var update = __webpack_require__(3)("6bce1784", content, true);
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(3)("6d2ece9c", content, true);
